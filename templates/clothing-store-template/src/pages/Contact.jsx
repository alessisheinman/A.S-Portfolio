        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              We'd love to hear from you. Visit us in store or reach out online.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:hello@luxeboutique.com"
                      className="text-accent-600 hover:text-accent-700"
                    >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-900 mb-1">Hours</h3>
            ...
            >
              <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gray-900 text-white px-8 py-4 rounded-lg hover:bg-accent-500 transition-colors font-semibold text-lg"
                  >
                    Send Message
                  </button>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Our style consultants are available in-store and by phone to help you find the perfect pieces for your wardrobe. We also offer personal styling appointments.
          </p>
          <a
            href="tel:+12125551234"
            className="inline-block border-2 border-gray-900 text-gray-900 px-8 py-3 rounded-lg hover:bg-gray-900 hover:text-white transition-colors font-semibold"
          >
